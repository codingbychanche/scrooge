...
public class FragmentDialogYesNo extends DialogFragment {
    ...
    // Empty Constructor!
    public FragmentDialogYesNo(){
        // Constructor must be empty....
    }

    public static FragmentDialogYesNo newInstance (int reqCode, int options, int data, Bitmap icon, String dialogText, String yesText, String noText){
        FragmentDialogYesNo frag=new FragmentDialogYesNo();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        screenShoot=(ImageView) view.findViewById(R.id.dialog_alert_symbol);
